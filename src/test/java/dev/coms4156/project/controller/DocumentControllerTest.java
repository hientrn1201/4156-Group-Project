...
class DocumentApiControllerTest {
    ...
    private Document makeDoc(Long id, String filename, String contentType, long size,Document.ProcessingStatus status, String summary) {
    ...
    void testGetDocument_Success() {
        // Given
        Long documentId = 1L;
         Document document = makeDoc(documentId, "test.pdf", "application/pdf", 1024L,Document.ProcessingStatus.COMPLETED, "Test summary"
    );
...
void testGetProcessingStatistics_AllStatuses() {
    List<Document> all = List.of(makeDoc(1L,"a", "t", 1,Document.ProcessingStatus.UPLOADED,null),makeDoc(2L, "b","t",1, Document.ProcessingStatus.TEXT_EXTRACTED,null),makeDoc(3L,"c","t", 1,Document.ProcessingStatus.CHUNKED,null),makeDoc(4L,"d","t", 1, Document.ProcessingStatus.EMBEDDINGS_GENERATED, null),
makeDoc(5L,"e","t",1, Document.ProcessingStatus.SUMMARIZED, null), makeDoc(6L, "f", "t", 1, Document.ProcessingStatus.COMPLETED, null), makeDoc(7L, "g", "t", 1, Document.ProcessingStatus.FAILED, null)
    );
